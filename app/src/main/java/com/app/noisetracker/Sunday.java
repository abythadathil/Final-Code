...
public class Sunday extends AppCompatActivity {
    ...
    Button start, stop, subsunday;

    int sundayh1=0,sundaym1=0,sundayh2=0,sundaym2=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rd1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                status.setText("No Recording for Sunday ");
        ...
        rd2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                status.setText("Always Recording for Sunday");
            }
        });
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mTimePicker = new TimePickerDialog(Sunday.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
        //                status.setText( "Recording will be done on Sunday between " + selectedHour + ":" + selectedMinute);


                        sundayh1 = selectedHour;
                        sundaym1 = selectedMinute;

                        SharedPreferences sharedPreferences = getSharedPreferences("SUNDAY", MODE_PRIVATE);
                        SharedPreferences.Editor myEdit = sharedPreferences.edit();

                        myEdit.putInt("hour1",sundayh1);
                        myEdit.putInt("min1",sundaym1);
        ...
        stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mTimePicker = new TimePickerDialog(Sunday.this, new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
                        //                status.setText( "Recording will be done on Sunday between " + selectedHour + ":" + selectedMinute);
                        sundayh2 = selectedHour;
                        sundaym2 = selectedMinute;

                        SharedPreferences sharedPreferences = getSharedPreferences("SUNDAY", MODE_PRIVATE);
                        SharedPreferences.Editor myEdit = sharedPreferences.edit();

                        myEdit.putInt("hour2",sundayh2);
                        myEdit.putInt("min2",sundaym2);

                        myEdit.apply();

                        status.setText("Recording set between " + sundayh1 + ":" + sundaym1 +" to " + sundayh2 + ":" + sundaym2 );

                        Toast.makeText(Sunday.this, "Recorder set..", Toast.LENGTH_SHORT).show();
 ...
 //       status.setText(stat);
        ...
        if(stat.contentEquals("Schedule Time")){
            ...
            status.setText("Always Recording on Sunday");
        }else if(stat.contentEquals("No Recording")){
            status.setText("No Recording on Sunday");
        }
        ...
        radioGroup.setOnCheckedChangeListener(
                new RadioGroup
                                                 ...
                                                 int checkedId)
                    {
                        ...
                        myEdit.putInt("mychoiced1", radioGroup.indexOfChild(findViewById(radioGroup.getCheckedRadioButtonId())));
    ...
    public void onBackPressed(){
        ...
        startActivity(new Intent(Sunday.this,RecordingSchedule.class));
